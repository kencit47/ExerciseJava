...
public class TamGiac2Test {
    ...
    public void test_tamgiac2(){
        assertEquals(new TamGiac2().tamGiac2(3,3,5,5,3,7),"Type - chu vi - dien tich : Tam giac vuong - 9.65685424949238 - 4.0");
        assertEquals(new TamGiac2().tamGiac2(6,10,8,7,11,9),"Type - chu vi - dien tich : Tam giac can - 12.310122064520764 - 6.5");
